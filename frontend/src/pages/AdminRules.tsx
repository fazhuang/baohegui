 ...
 *
 * 编排层：使用 features/rules/hooks 的状态管理。
 * Tab 视图组件保留在本文件（视图不属于 hook 范畴）。
 */
...
import { createPlatformRule, updatePlatformRule, deletePlatformRule } from '../services/api'
import { useRuleList, useSyncManager, useDashboardTab } from '../features/rules/hooks'
